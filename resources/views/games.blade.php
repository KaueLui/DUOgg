                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-4">
                     ...
                     <div class="p-3 border">
                        <div class="mt-3 px-2 border-b">{{ $game->name}} {{ $game->developer}} {{ $game->description}}</div>
                        <div class="grid grid-colums-2">
                          <a href="">Edit</a>
                          <a href="">Delete</a>
    ...
    <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
                    ...
                    <div class="p-3">
                        ...
                        <form action="" method="POST"> 
                            ...
                            $communities = \App\Models\Community::where('user_id', Auth::user()->id)->get()->sortBy('name')
            ...
            <div class="mt-4">
                ...
                <x-input id="developer" class="block mt-1 w-full" type="text" name="developer" :value="old('developer')" required />
            </div>
